    ...
    def __init__(self, app: gt.Base, game, player: gt.Entites) -> None:
        ...
        def follow_player():
            ...
            if distance_x > app.size[0]//2-distance_to_border and is_living_x:
                ...
                elif self.sprite.rect.x+self.sprite.get_size()[0] > game.map.size[0]:
            ...
            if distance_y > app.size[1]//2-distance_to_border and is_living_y:
                ...
                elif self.sprite.rect.y+self.sprite.get_size()[1] > game.map.size[1]:
                    self.sprite.rect.y = game.map.size()[1]-self.sprite.get_size()[1]